...
const SectionTitle = ({ children }) => {
    return(
        <span className="col-span-6 text-label-large font-bold text-on-surface-variant">{children}</span>
    )
}
    ...
    if(theme.masonite) {
        return(
            <>
                ...
                <SectionTitle>Advisar</SectionTitle>
    ...
    return(
        <Collapse title={`${mode}`}>
            <div className="grid grid-cols-6 gap-2">
                ...
                <SectionTitle>Grey</SectionTitle>
                ...
                <SectionTitle>Blue Grey</SectionTitle>
                ...
                <SectionTitle>Light Green</SectionTitle>
                ...
                <SectionTitle>Indigo</SectionTitle>
                ...
                <TokenBlock color={theme.teal.muted} text={theme.text.default}>teal.muted</TokenBlock>
                <TokenBlock color={theme.teal.text} text={theme.text.contrast}>teal.text</TokenBlock>
                <SectionTitle>Deep Purple</SectionTitle>
                ...
                <SectionTitle>Amber</SectionTitle>
